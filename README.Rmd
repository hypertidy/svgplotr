...
This figure is nevertheless logarithically scaled, indicating that efficiency
gains decrease exponentially with increasing size, so maybe it's not worth it
after all?
